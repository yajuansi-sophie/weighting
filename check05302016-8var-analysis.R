...
plot(n_cell,(apply(output_iid$mu_cell,2,mean)-mu_cell_use)^2)
plot(n_cell,(apply(output$mu_cell,2,mean)-mu_cell_use)^2)

summary((apply(output$mu_cell,2,mean)-mu_cell_use)^2/(apply(output_iid$mu_cell,2,mean)-mu_cell_use)^2)
...
save.image("output/simulation_8var_20160527_case4_Ymain_Imain.RData")

############################################################################################################
load('output/simulation_8var_20160527_case1_all.RData')#did not converge
load('output/simulation_8var_20160527_case2_Ymain_Iall.RData')
load('output/simulation_8var_20160527_case3_Yall_Imain.RData')#did not converge
load("output/simulation_8var_20160527_case4_Ymain_Imain.RData")
