...
lambda_m <- 1
for (r in 1:R){
  sigma_y <- 2; #abs(rnorm(1,0,1))
  sigma_m <- c(1,1); #abs(rnorm(q,0,1))
  lambda_inter <- runif(1,0,1)
...
S.compile_cell <- stan(file='stan/mrpweights11172015-2var.stan',
                       data=stan.data_cell,
                       iter=2, chains=1)
