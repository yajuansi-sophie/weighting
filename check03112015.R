...
# output1<-extract(S, permuted=TRUE)
#  plot(output1$lambda_m)
#  plot(output1$lambda_inter)
#  plot(output1$lambda_inter[,1])
#  plot(output1$lambda_inter[,2], output1$sigma_m[,1] * output1$sigma_m[,2])
# plot(output1$lambda_inter[,2]* output1$sigma_m[,1] * output1$sigma_m[,2]*output1$sigma_m[,3])
# (output1$lambda_inter[,2]* output1$sigma_m[,1] * output1$sigma_m[,2]*output1$sigma_m[,3])
# 
# mean(output1$lambda_inter[,1]* output1$sigma_m[,2] * output1$sigma_m[,3])
# lambda_inter[1] * sigma_m[2] * sigma_m[3]
# mean(output1$lambda_inter[,1]* output1$sigma_m[,1] * output1$sigma_m[,3])
# lambda_inter[1] * sigma_m[1] * sigma_m[3]
# mean(output1$lambda_inter[,1]* output1$sigma_m[,2] * output1$sigma_m[,3])
# lambda_inter[1] * sigma_m[2] * sigma_m[3]
# 
# plot(output1$lambda_m * output1$sigma_m[,1])
# plot(output1$lambda_m * output1$sigma_m[,2])
# plot(output1$lambda_m * output1$sigma_m[,3])
# plot(output1$lambda_inter)
# plot(output1$lambda_inter[,1] * output1$sigma_m[,1] * output1$sigma_m[,2])
# plot(output1$lambda_inter[,1] * output1$sigma_m[,1] * output1$sigma_m[,3])
# plot(output1$lambda_inter[,1] * output1$sigma_m[,2] * output1$sigma_m[,3])
# plot(output1$lambda_inter[,2])
...
save.image("check_mrp_20150311a.RData")
