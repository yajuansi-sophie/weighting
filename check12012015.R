...
4.791  12.700  17.150  19.870  24.390  80.870 
> hist(output$pri_var)
> apply(output$sigma_m,2,summary)

[,1]   [,2]   [,3]
Min.    0.2733 0.1557 0.6426
1st Qu. 1.8870 2.0060 1.1010
Median  2.5220 2.5540 1.3460
Mean    2.7590 2.7070 1.4680
3rd Qu. 3.4170 3.2420 1.7010
Max.    8.5290 8.0080 4.2160
pri_var
[1] 14.65332
> sigma_m
[1] 1.725241 3.174909 1.263651

  sigma_y <- abs(rnorm(1,0,1)*2.5)
  sigma_m <- abs(rnorm(q+1,0,1)*2.5)
