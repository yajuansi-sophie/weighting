...
S.compile_cell_1 <- stan(file='stan/mrpweights05052016-3var-iid.stan',
                         data=stan.data_cell,
                         iter=2, chains=1)
...
save.image("output/check_3var_20160505_case6_Y2var_Imain.RData")
