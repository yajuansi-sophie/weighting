...
#   alpha <-0;
#   set.seed(20150722)
#   alpha_age <- rnorm(J_age) * 2 +3; alpha_eth <-rnorm(J_eth)*0.1 + 2 ; 
#   alpha_edu <- rnorm(J_edu) * 0.5 -4;
#   alpha_age_eth<-rnorm(J_age * J_eth)-1; alpha_age_edu <-rnorm(J_age * J_edu) * 1.5-2;
#   alpha_eth_edu <-rnorm(J_eth * J_edu)*0.5 + 1; alpha_age_eth_edu <-rnorm(J_age * J_eth * J_edu)
#   
...
pdf("plot/model-wght10132015.pdf")
...
pdf("plot/model_wgh_prop10132015.pdf")
...
pdf("plot/lambda_inter1_10132015.pdf")
...
pdf("plot/lambda_inter2_10132015.pdf")
