...
generated quantities{
 ...
 for (j in 1:J_true){
  ...
  alpha_inc[cell_str[j,4]] * sigma_m * lambda_m[4] +
  ...
  alpha_age_inc[(cell_str[j,4]-1) * J_age + cell_str[j,1]] * lambda_inter[1] * lambda_m[1] * lambda_m[4] * sigma_m +
  alpha_eth_inc[(cell_str[j,4]-1) * J_eth + cell_str[j,2]] * lambda_inter[1] * lambda_m[2] * lambda_m[4] * sigma_m +
  alpha_age_eth_edu[(cell_str[j,3]-1) * J_eth * J_age + (cell_str[j,2]-1) * J_age + cell_str[j,1]] * lambda_inter[2] * lambda_m[1] * lambda_m[2] * lambda_m[3] * sigma_m +
     alpha_age_eth_inc[(cell_str[j,4]-1) * J_eth * J_age + (cell_str[j,2]-1) * J_age + cell_str[j,1]] * lambda_inter[2] * lambda_m[1] * lambda_m[2] * lambda_m[4] * sigma_m; 
  }
