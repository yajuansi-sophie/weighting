...
mu_mean<-function(x_value){
  alpha + alpha_age[x_value[1]] * lambda_m[1] * sigma_m + 
    ...
    alpha_age_eth[(x_value[1]-1) * J_eth + x_value[2]] * lambda_inter[1] * lambda_m[1] * lambda_m[2] * sigma_m +
    alpha_age_edu[(x_value[1]-1) * J_edu + x_value[3]] * lambda_inter[1] * lambda_m[1] * lambda_m[3] * sigma_m +
    alpha_eth_edu[(x_value[2]-1) * J_edu + x_value[3]] * lambda_inter[1] * lambda_m[2] * lambda_m[3] * sigma_m +
    alpha_age_eth_edu[(x_value[1]-1) * J_eth * J_edu + (x_value[2]-1) * J_edu + 
                        x_value[3]] * lambda_inter[2] * lambda_m[1] * lambda_m[2] * lambda_m[3] * sigma_m;
}
...
S.compile_cell_2 <- stan(file='stan/mrpweights02042016-3var.stan',
                         data=stan.data_cell,
                         iter=2, chains=1)
...
# 10.47   20.53   25.76   29.93   33.81  148.90 
# > hist(output$pri_var)
# > pri_var
# [1] 32.16834
